TISO LIVE - FULL SOURCE, GIAY PHEP MIT

Noi dung goi:
- UnityProject: toan bo source Unity, scene, script va asset cua game.
- TikTokBridge: Node.js bridge, TikTok/TikFinity, Control va Master Rules.
...
1. Tai file TISO-Live-Windows-v1.0.5.zip trong muc Releases cua GitHub.
2. Giai nen toan bo ZIP ra thu muc moi. Khong chay truc tiep ben trong ZIP.
3. Cai Node.js 20 tro len, sau do nhan dup run.bat.
4. Neu cong cua Bridge (mac dinh 3100) dang bi chiem, dong dung chuong trinh duoc bao roi chay lai.
   Launcher khong tu tat chuong trinh khac de tranh mat du lieu.

Dau hieu thanh cong:
- Cua so TikTok Bridge hien dia chi theo PORT trong .env (mac dinh http://127.0.0.1:3100).
...
2. Chay: npm ci
3. Chay: npm start
4. Mo: http://127.0.0.1:3100/control.html (theo PORT trong .env)
